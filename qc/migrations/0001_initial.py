...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('role', models.CharField(choices=[('header', 'Header'), ('staff', 'Staff'), ('crafstman', 'Crafstman')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[("didn't assign", "Didn't assign"), ('waiting', 'Waiting'), ('passed', 'Passed'), ('rejected', 'Rejected'), ('completed', 'Completed')], default="didn't assign", max_length=200)),
                ('created', models.DateTimeField(auto_now_add=True)),
                ...
                ('craftsman', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='craftsman', to='qc.profile')),
